...
- Horizontal Scaling (using $b$)
	- If $|b| > 1$: {{% abbr "horizontal stretch" %}}hs{{% /abbr %}} by $b$.
	- Else if $0 < |b| < 1$: {{% abbr "horizontal compress" %}}hc{{% /abbr %}} by $b$.
...
## Lesson 5: Absolute Values and Inequalities
...
## Lesson 5: Inverses of Functions
